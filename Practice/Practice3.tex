...
\begin{document}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \item
            ...
            \end{align*}
            resulting in 
            % $p = 0.4$ and $C = H_b(0.2) - 0.4 = 0.3219$.
            \begin{align*}
               & p = 0.4 \\ 
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \item 
            ...
            \end{align*}
            A block diagram of the transmitter is shown in figure 3.
            \begin{figure}[h]
            	\centering
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \item 
            ...
            \end{align*}
            \newpage
            A sketch of the spectrum of the transmitted signal pulse is shown in Figure 4. 
            \begin{figure}[h]
            	\centering
            	\includegraphics[scale=0.55]{Practice3-7-1.png}
